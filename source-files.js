...
sourcesIndex["backup_cli"] = {"name":"","dirs":[{"name":"backup_types","dirs":[{"name":"epoch_ending","files":["backup.rs","manifest.rs","mod.rs","restore.rs"]},{"name":"state_snapshot","files":["backup.rs","manifest.rs","mod.rs","restore.rs"]},{"name":"transaction","files":["backup.rs","manifest.rs","mod.rs","restore.rs"]}],"files":["mod.rs"]},{"name":"coordinators","files":["backup.rs","mod.rs","restore.rs","verify.rs"]},{"name":"metadata","files":["cache.rs","mod.rs","view.rs"]},{"name":"metrics","files":["backup.rs","metadata.rs","mod.rs","restore.rs","verify.rs"]},{"name":"storage","dirs":[{"name":"command_adapter","files":["command.rs","config.rs","mod.rs"]},{"name":"local_fs","files":["mod.rs"]}],"files":["mod.rs"]},{"name":"utils","dirs":[{"name":"stream","files":["buffered_x.rs","futures_ordered_x.rs","futures_unordered_x.rs","mod.rs"]}],"files":["backup_service_client.rs","error_notes.rs","mod.rs","read_record_bytes.rs","storage_ext.rs"]}],"files":["lib.rs"]};
sourcesIndex["backup_service"] = {"name":"","dirs":[{"name":"handlers","files":["mod.rs","utils.rs"]}],"files":["lib.rs"]};
sourcesIndex["boogie_backend"] = {"name":"","files":["boogie_helpers.rs","boogie_wrapper.rs","bytecode_translator.rs","lib.rs","prover_task_runner.rs","spec_translator.rs"]};
sourcesIndex["boogie_backend_v2"] = {"name":"","files":["boogie_helpers.rs","boogie_wrapper.rs","bytecode_translator.rs","lib.rs","options.rs","prover_task_runner.rs","spec_translator.rs"]};
...
sourcesIndex["bytecode"] = {"name":"","files":["access_path.rs","access_path_trie.rs","annotations.rs","borrow_analysis.rs","clean_and_optimize.rs","compositional_analysis.rs","data_invariant_instrumentation.rs","dataflow_analysis.rs","debug_instrumentation.rs","eliminate_imm_refs.rs","function_data_builder.rs","function_target.rs","function_target_pipeline.rs","global_invariant_instrumentation.rs","global_invariant_instrumentation_v2.rs","graph.rs","lib.rs","livevar_analysis.rs","loop_analysis.rs","memory_instrumentation.rs","mut_ref_instrumentation.rs","options.rs","packed_types_analysis.rs","reaching_def_analysis.rs","read_write_set_analysis.rs","spec_instrumentation.rs","spec_translator.rs","stackless_bytecode.rs","stackless_bytecode_generator.rs","stackless_control_flow_graph.rs","usage_analysis.rs","verification_analysis.rs"]};
sourcesIndex["bytecode_source_map"] = {"name":"","files":["lib.rs","mapping.rs","marking.rs","source_map.rs","utils.rs"]};
sourcesIndex["bytecode_verifier"] = {"name":"","dirs":[{"name":"locals_safety","files":["abstract_state.rs","mod.rs"]},{"name":"reference_safety","files":["abstract_state.rs","mod.rs"]}],"files":["ability_field_requirements.rs","absint.rs","acquires_list_verifier.rs","binary_views.rs","check_duplication.rs","code_unit_verifier.rs","constants.rs","control_flow.rs","control_flow_graph.rs","cyclic_dependencies.rs","dependencies.rs","friends.rs","instantiation_loops.rs","instruction_consistency.rs","lib.rs","script_signature.rs","signature.rs","stack_usage_verifier.rs","struct_defs.rs","type_safety.rs","verifier.rs"]};
...
sourcesIndex["cluster_test"] = {"name":"","dirs":[{"name":"cluster_swarm","files":["cluster_swarm_kube.rs","mod.rs"]},{"name":"effects","files":["mod.rs","network_delay.rs","packet_loss.rs","stop_validator.rs"]},{"name":"experiments","files":["compatibility_test.rs","cpu_flamegraph.rs","load_test.rs","mod.rs","packet_loss_random_validators.rs","performance_benchmark.rs","performance_benchmark_three_region_simulation.rs","reboot_cluster.rs","reboot_random_validators.rs","reconfiguration_test.rs","recovery_time.rs","twin_validator.rs","versioning_test.rs"]},{"name":"health","files":["commit_check.rs","debug_interface_log_tail.rs","fullnode_check.rs","liveness_check.rs","log_tail.rs","mod.rs"]}],"files":["atomic_histogram.rs","aws.rs","cluster.rs","cluster_builder.rs","genesis_helper.rs","github.rs","instance.rs","lib.rs","prometheus.rs","report.rs","slack.rs","stats.rs","suite.rs","tx_emitter.rs"]};
sourcesIndex["compiled_stdlib"] = {"name":"","dirs":[{"name":"legacy","files":["mod.rs","transaction_scripts.rs"]}],"files":["lib.rs"]};
sourcesIndex["compiler"] = {"name":"","files":["lib.rs","util.rs"]};
sourcesIndex["consensus"] = {"name":"","dirs":[{"name":"block_storage","files":["block_store.rs","block_tree.rs","mod.rs","sync_manager.rs","tracing.rs"]},{"name":"consensusdb","dirs":[{"name":"schema","dirs":[{"name":"block","files":["mod.rs"]},{"name":"quorum_certificate","files":["mod.rs"]},{"name":"single_entry","files":["mod.rs"]}],"files":["mod.rs"]}],"files":["mod.rs"]},{"name":"liveness","files":["leader_reputation.rs","mod.rs","proposal_generator.rs","proposer_election.rs","rotating_proposer_election.rs","round_proposer_election.rs","round_state.rs"]},{"name":"test_utils","files":["mock_state_computer.rs","mock_storage.rs","mock_txn_manager.rs","mod.rs"]},{"name":"util","files":["config_subscription.rs","mock_time_service.rs","mod.rs","time_service.rs"]}],"files":["consensus_provider.rs","counters.rs","epoch_manager.rs","error.rs","lib.rs","logging.rs","metrics_safety_rules.rs","network.rs","network_interface.rs","pending_votes.rs","persistent_liveness_storage.rs","round_manager.rs","round_manager_fuzzing.rs","state_computer.rs","state_replication.rs","txn_manager.rs"]};
...
sourcesIndex["diem_client"] = {"name":"","files":["blocking.rs","client.rs","error.rs","lib.rs","macros.rs","proxy.rs","request.rs","response.rs","retry.rs","state.rs"]};
sourcesIndex["diem_config"] = {"name":"","dirs":[{"name":"config","files":["consensus_config.rs","debug_interface_config.rs","error.rs","execution_config.rs","json_rpc_config.rs","key_manager_config.rs","logger_config.rs","mempool_config.rs","metrics_config.rs","mod.rs","network_config.rs","safety_rules_config.rs","secure_backend_config.rs","state_sync_config.rs","storage_config.rs","test_config.rs","upstream_config.rs"]}],"files":["generator.rs","keys.rs","lib.rs","network_id.rs","utils.rs"]};
sourcesIndex["diem_crypto"] = {"name":"","files":["compat.rs","ed25519.rs","error.rs","hash.rs","hkdf.rs","lib.rs","multi_ed25519.rs","noise.rs","test_utils.rs","traits.rs","x25519.rs"]};
...
sourcesIndex["diem_framework"] = {"name":"","files":["lib.rs","release.rs"]};
...
sourcesIndex["diem_genesis_tool"] = {"name":"","files":["command.rs","config_builder.rs","genesis.rs","key.rs","layout.rs","lib.rs","storage_helper.rs","swarm_config.rs","validator_config.rs","validator_operator.rs","verify.rs","waypoint.rs"]};
...
sourcesIndex["diem_jellyfish_merkle"] = {"name":"","dirs":[{"name":"iterator","files":["mod.rs"]},{"name":"nibble_path","files":["mod.rs"]},{"name":"node_type","files":["mod.rs"]},{"name":"restore","files":["mod.rs"]},{"name":"tree_cache","files":["mod.rs"]}],"files":["lib.rs","metrics.rs","mock_tree_store.rs","test_helper.rs"]};
sourcesIndex["diem_json_rpc"] = {"name":"","dirs":[{"name":"tests","files":["mod.rs","utils.rs"]}],"files":["counters.rs","fuzzing.rs","lib.rs","methods.rs","runtime.rs","util.rs"]};
sourcesIndex["diem_json_rpc_client"] = {"name":"","dirs":[{"name":"async_client","files":["client.rs","defaults.rs","error.rs","http_client.rs","mod.rs","retry.rs","state.rs"]}],"files":["broadcast_client.rs","lib.rs"]};
sourcesIndex["diem_json_rpc_types"] = {"name":"","dirs":[{"name":"proto","files":["mod.rs"]}],"files":["constants.rs","errors.rs","lib.rs","response.rs","views.rs"]};
...
sourcesIndex["diem_logger"] = {"name":"","files":["counters.rs","diem_logger.rs","event.rs","filter.rs","json_log.rs","kv.rs","lib.rs","logger.rs","macros.rs","metadata.rs","sample.rs","security.rs","struct_log.rs"]};
...
sourcesIndex["diem_mempool"] = {"name":"","dirs":[{"name":"core_mempool","files":["index.rs","mempool.rs","mod.rs","transaction.rs","transaction_store.rs","ttl_cache.rs"]},{"name":"shared_mempool","files":["coordinator.rs","mod.rs","network.rs","peer_manager.rs","runtime.rs","tasks.rs","types.rs"]},{"name":"tests","files":["fuzzing.rs","mocks.rs","mod.rs"]}],"files":["counters.rs","lib.rs","logging.rs"]};
...
sourcesIndex["diem_nibble"] = {"name":"","files":["lib.rs"]};
...
sourcesIndex["diem_sdk"] = {"name":"","files":["lib.rs"]};
sourcesIndex["diem_secure_net"] = {"name":"","files":["lib.rs"]};
sourcesIndex["diem_secure_push_metrics"] = {"name":"","files":["lib.rs"]};
sourcesIndex["diem_secure_storage"] = {"name":"","files":["crypto_kv_storage.rs","crypto_storage.rs","error.rs","github.rs","in_memory.rs","kv_storage.rs","lib.rs","namespaced_storage.rs","on_disk.rs","policy.rs","storage.rs","vault.rs"]};
sourcesIndex["diem_smoke_test_attribute"] = {"name":"","files":["lib.rs"]};
sourcesIndex["diem_state_view"] = {"name":"","files":["lib.rs"]};
sourcesIndex["diem_swarm"] = {"name":"","files":["client.rs","faucet.rs","lib.rs","swarm.rs"]};
...
sourcesIndex["diem_trace"] = {"name":"","files":["counters.rs","lib.rs","trace.rs"]};
sourcesIndex["diem_transaction_builder"] = {"name":"","files":["lib.rs","stdlib.rs"]};
sourcesIndex["diem_transaction_replay"] = {"name":"","files":["lib.rs"]};
sourcesIndex["diem_types"] = {"name":"","dirs":[{"name":"account_config","dirs":[{"name":"constants","files":["account.rs","addresses.rs","coins.rs","diem.rs","event.rs","mod.rs"]},{"name":"events","files":["admin_transaction.rs","base_url_rotation.rs","burn.rs","cancel_burn.rs","compliance_key_rotation.rs","create_account.rs","exchange_rate_update.rs","mint.rs","mod.rs","new_block.rs","new_epoch.rs","preburn.rs","received_mint.rs","received_payment.rs","sent_payment.rs"]},{"name":"resources","files":["account.rs","balance.rs","chain_id.rs","currency_info.rs","designated_dealer.rs","dual_attestation.rs","freezing_bit.rs","key_rotation_capability.rs","mod.rs","preburn_balance.rs","preburn_queue.rs","preburn_with_metadata.rs","role.rs","role_id.rs","vasp.rs","withdraw_capability.rs"]}],"files":["mod.rs"]},{"name":"network_address","files":["encrypted.rs","mod.rs"]},{"name":"on_chain_config","files":["diem_version.rs","mod.rs","registered_currencies.rs","validator_set.rs","vm_config.rs","vm_publishing_option.rs"]},{"name":"proof","dirs":[{"name":"accumulator","files":["mod.rs"]},{"name":"position","files":["mod.rs"]}],"files":["definition.rs","mod.rs","proptest_proof.rs"]},{"name":"serde_helper","files":["mod.rs","vec_bytes.rs"]},{"name":"test_helpers","files":["mod.rs","transaction_test_helpers.rs"]},{"name":"transaction","files":["authenticator.rs","change_set.rs","helpers.rs","metadata.rs","mod.rs","module.rs","script.rs","transaction_argument.rs"]}],"files":["access_path.rs","account_address.rs","account_state.rs","account_state_blob.rs","block_info.rs","block_metadata.rs","chain_id.rs","contract_event.rs","diem_timestamp.rs","epoch_change.rs","epoch_state.rs","event.rs","ledger_info.rs","lib.rs","mempool_status.rs","move_resource.rs","proptest_types.rs","trusted_state.rs","validator_config.rs","validator_info.rs","validator_signer.rs","validator_verifier.rs","vm_status.rs","waypoint.rs","write_set.rs"]};
...
sourcesIndex["diem_vm"] = {"name":"","files":["access_path_cache.rs","counters.rs","data_cache.rs","diem_transaction_executor.rs","diem_transaction_validator.rs","diem_vm.rs","errors.rs","lib.rs","logging.rs","script_to_script_function.rs","system_module_names.rs","transaction_metadata.rs"]};
...
sourcesIndex["diem_writeset_generator"] = {"name":"","dirs":[{"name":"release_flow","files":["artifacts.rs","create.rs","mod.rs","verify.rs"]}],"files":["admin_script_builder.rs","lib.rs","writeset_builder.rs"]};
sourcesIndex["diemdb"] = {"name":"","dirs":[{"name":"backup","files":["backup_handler.rs","mod.rs","restore_handler.rs"]},{"name":"diemsum","files":["mod.rs"]},{"name":"event_store","files":["mod.rs"]},{"name":"ledger_counters","files":["mod.rs"]},{"name":"ledger_store","files":["mod.rs"]},{"name":"pruner","files":["mod.rs"]},{"name":"schema","dirs":[{"name":"epoch_by_version","files":["mod.rs"]},{"name":"event","files":["mod.rs"]},{"name":"event_accumulator","files":["mod.rs"]},{"name":"event_by_key","files":["mod.rs"]},{"name":"event_by_version","files":["mod.rs"]},{"name":"jellyfish_merkle_node","files":["mod.rs"]},{"name":"ledger_counters","files":["mod.rs"]},{"name":"ledger_info","files":["mod.rs"]},{"name":"stale_node_index","files":["mod.rs"]},{"name":"transaction","files":["mod.rs"]},{"name":"transaction_accumulator","files":["mod.rs"]},{"name":"transaction_by_account","files":["mod.rs"]},{"name":"transaction_info","files":["mod.rs"]}],"files":["mod.rs"]},{"name":"state_store","files":["mod.rs"]},{"name":"system_store","files":["mod.rs"]},{"name":"transaction_store","files":["mod.rs"]}],"files":["change_set.rs","diemdb_test.rs","errors.rs","lib.rs","metrics.rs","test_helper.rs"]};
sourcesIndex["diemdb_benchmark"] = {"name":"","files":["lib.rs"]};
...
sourcesIndex["language_benchmarks"] = {"name":"","files":["lib.rs","measurement.rs","move_vm.rs","transactions.rs"]};
sourcesIndex["language_e2e_tests"] = {"name":"","dirs":[{"name":"account_universe","files":["bad_transaction.rs","create_account.rs","peer_to_peer.rs","rotate_key.rs","universe.rs"]},{"name":"execution_strategies","files":["basic_strategy.rs","guided_strategy.rs","mod.rs","multi_strategy.rs","random_strategy.rs","types.rs"]}],"files":["account.rs","account_universe.rs","common_transactions.rs","compile.rs","currencies.rs","data_store.rs","executor.rs","gas_costs.rs","golden_outputs.rs","keygen.rs","lib.rs","on_chain_configs.rs","proptest_types.rs","utils.rs","versioning.rs"]};
...
sourcesIndex["network"] = {"name":"","dirs":[{"name":"connectivity_manager","files":["builder.rs","mod.rs"]},{"name":"noise","files":["error.rs","fuzzing.rs","handshake.rs","mod.rs","stream.rs"]},{"name":"peer","files":["fuzzing.rs","mod.rs"]},{"name":"peer_manager","files":["builder.rs","conn_notifs_channel.rs","error.rs","mod.rs"]},{"name":"protocols","dirs":[{"name":"direct_send","files":["mod.rs"]},{"name":"health_checker","files":["builder.rs","mod.rs"]},{"name":"network","files":["mod.rs"]},{"name":"rpc","files":["error.rs","mod.rs"]},{"name":"wire","dirs":[{"name":"handshake","dirs":[{"name":"v1","files":["mod.rs"]}]},{"name":"messaging","dirs":[{"name":"v1","files":["mod.rs"]}]}],"files":["handshake.rs","messaging.rs","mod.rs"]}],"files":["identity.rs","mod.rs"]},{"name":"testutils","files":["fake_socket.rs","mod.rs"]},{"name":"transport","files":["mod.rs"]}],"files":["constants.rs","counters.rs","error.rs","fuzzing.rs","lib.rs","logging.rs"]};
...
sourcesIndex["state_sync"] = {"name":"","files":["bootstrapper.rs","chunk_request.rs","chunk_response.rs","client.rs","coordinator.rs","counters.rs","error.rs","executor_proxy.rs","fuzzing.rs","lib.rs","logging.rs","network.rs","request_manager.rs","shared_components.rs"]};
...
sourcesIndex["vm"] = {"name":"","dirs":[{"name":"proptest_types","files":["constants.rs","functions.rs","signature.rs","types.rs"]}],"files":["access.rs","check_bounds.rs","compatibility.rs","constant.rs","deserializer.rs","errors.rs","file_format.rs","file_format_common.rs","internals.rs","lib.rs","normalized.rs","proptest_types.rs","serializer.rs","views.rs"]};
